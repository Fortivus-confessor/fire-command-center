...
import { Sidebar } from "../components/fortivus/Sidebar";
import { TopBar } from "../components/fortivus/TopBar";
import { LandingPage } from "../components/fortivus/LandingPage";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Roboto+Condensed:wght@400;500;700&display=swap",
      },
      {
        rel: "icon",
        type: "image/png",
