  ...
  if (typeof window === "undefined") {
    return (
      <div
        ...
        className="w-full bg-secondary/20 border border-border rounded-lg animate-pulse"
      />
    );
  }
  ...
  return (
    <Suspense
      fallback={
        <div
          style={{ height: props.height || "300px" }}
          className="w-full bg-secondary/20 border border-border rounded-lg animate-pulse flex items-center justify-center"
        >
